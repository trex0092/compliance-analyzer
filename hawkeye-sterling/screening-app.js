  ...
  function getComplianceGuidance(result) {
    if (result === 'MATCH') return {
      ...
      actions:
        ...
        +'<div class="hs-action-item critical"><span class="hs-action-num">2</span><div><strong>FILE STR VIA goAML \u2014 WITHOUT ANY PRIOR CONSENT</strong><p>File a <strong>Suspicious Transaction Report (STR)</strong> directly to the UAE FIU through the goAML portal. If the suspicious activity involved an attempted or non-executed transaction, file a <strong>Suspicious Activity Report (SAR)</strong> instead. <strong>YOU DO NOT NEED ANY PRIOR CONSENT OR APPROVAL</strong> \u2014 not from your manager, not from the board, not from the customer. File immediately regardless of value. For DPMS entities, also consider filing a <strong>DPMSR</strong> (Dealers in Precious Metals and Stones Report) if the activity relates to precious metals/stones transactions. (FDL Art.15-16)</p><div class="hs-goaml-ref">goAML Report Types: <span class="hs-goaml-tag str">STR</span> <span class="hs-goaml-tag sar">SAR</span> <span class="hs-goaml-tag dpmsr">DPMSR</span></div></div></div>'
