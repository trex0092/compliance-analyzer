  ...
  function getComplianceGuidance(result) {
    if (result === 'MATCH') return {
      ...
      actions:
        ...
        +'<div class="hs-action-item critical"><span class="hs-action-num">2</span><div><strong>FILE STR VIA goAML \u2014 WITHOUT ANY PRIOR CONSENT</strong><p>File a Suspicious Transaction Report directly to the UAE Financial Intelligence Unit (FIU) through the goAML portal. <strong>YOU DO NOT NEED ANY PRIOR CONSENT OR APPROVAL</strong> \u2014 not from your manager, not from the board, not from the customer. The legal obligation under FDL Art.15 is on YOU as the reporting entity. File immediately regardless of the transaction value, and regardless of whether the transaction was completed or merely attempted. (FDL Art.15-16)</p></div></div>'
        +'<div class="hs-action-item critical"><span class="hs-action-num">3</span><div><strong>FILE FUNDS FREEZE REPORT (FFR) VIA goAML</strong><p>Submit a Funds Freeze Report to the FIU via goAML portal immediately after executing the freeze. Include: details of the frozen assets (type, value, location), the designated person/entity details, the sanctions list matched, and the date/time of freeze execution. (FDL Art.22-23, EOCN TFS Guidance)</p></div></div>'
        +'<div class="hs-action-item critical"><span class="hs-action-num">4</span><div><strong>FILE CNMR TO EOCN WITHIN 5 BUSINESS DAYS</strong><p>Submit a Confirmed Name Match Report to the Executive Office for Control &amp; Non-Proliferation (EOCN) within 5 business days. Include: match details, actions taken, frozen asset values, sanctions list reference, and all supporting documentation. (Cabinet Decision 74/2020, EOCN TFS Guidance)</p></div></div>'
      ...
      deadlines:
        ...
        +'<li><strong>STR via goAML:</strong> IMMEDIATELY \u2014 no prior consent required (FDL Art.15-16)</li>'
        +'<li><strong>FFR via goAML:</strong> Immediately after freeze execution (FDL Art.22-23)</li>'
        ...
        +'<li><strong>MoE / Supervisory Authority:</strong> Without delay (FDL Art.35)</li>'
        +'</ul>',
      records:
        '<p>All records must be retained for a minimum of <strong>5 years</strong> from the date of the last transaction or termination of the business relationship (whichever is later). For DPMS under MoE supervision, the recommended period is <strong>10 years</strong>. Records include: screening results, STR filings, FFR filings, CNMR filings, freeze orders, correspondence with EOCN/FIU/MoE, customer files, and all transaction records. Records must be sufficient to permit reconstruction of individual transactions. (FDL Art.25, Cabinet Resolution 134/2025 Art.24, MoE Circular 08/AML/2021)</p>',
      footer: 'CRIMINAL PENALTIES: Non-compliance with TFS/AML obligations under FDL No.10/2025 may result in: imprisonment (Art.36-39), fines up to AED 5,000,000 (Art.40), dissolution of legal entities, confiscation of proceeds, deportation of non-UAE nationals, and/or publication of the conviction. The Compliance Officer, MLRO, and Senior Management may face PERSONAL criminal liability. Tipping off carries separate imprisonment penalties (Art.19).'
    };
    ...
    if (result === 'POTENTIAL_MATCH') return {
      ...
      actions:
        ...
        +'<div class="hs-action-item warning"><span class="hs-action-num">3</span><div><strong>FILE STR VIA goAML IF SUSPICION ARISES \u2014 NO PRIOR CONSENT NEEDED</strong><p>If at any point during the verification you develop suspicion of ML/TF, file an STR via goAML <strong>immediately and without seeking any prior consent or approval</strong>. The reporting obligation under FDL Art.15 is triggered by suspicion alone \u2014 you do not need to wait for match confirmation. (FDL Art.15-16)</p></div></div>'
        +'<div class="hs-action-item warning"><span class="hs-action-num">4</span><div><strong>FILE PNMR TO EOCN WITHIN 5 BUSINESS DAYS</strong><p>If the match cannot be definitively resolved, submit a Partial Name Match Report (PNMR) to the Executive Office for Control &amp; Non-Proliferation (EOCN) within 5 business days. Include all identifying data gathered, the basis for the potential match, and actions taken. (Cabinet Decision 74/2020, EOCN TFS Guidance)</p></div></div>'
      ...
      deadlines:
        ...
        +'<li><strong>STR (if suspicion arises):</strong> IMMEDIATELY \u2014 no prior consent needed (FDL Art.15)</li>'
    ...
    return {
      ...
      regulatory:
        ...
        +'<li><strong>UAE Federal Decree-Law No.(10) of 2025, Art.15 (Ongoing STR Obligation):</strong> Even with a negative screening result, if at any future point suspicion of ML/TF arises during the business relationship, an STR must be filed via goAML <strong>immediately and without any prior consent</strong>. The STR obligation is continuous and independent of screening results.</li>'
      ...
      actions:
        ...
        +'<div class="hs-action-item ok"><span class="hs-action-num">5</span><div><strong>APPLY ONGOING MONITORING &amp; STR OBLIGATION</strong><p>Monitor the business relationship continuously. If at ANY POINT suspicion of money laundering, terrorism financing, or other financial crime arises, file an STR via goAML <strong>immediately and without any prior consent</strong>. The STR obligation under FDL Art.15 applies throughout the entire business relationship, regardless of this negative screening result. (FDL Art.15-17)</p></div></div>',
      deadlines:
        '<ul>'
        ...
        +'<li><strong>STR (if suspicion arises):</strong> IMMEDIATELY \u2014 no prior consent needed (FDL Art.15)</li>'
        +'<li><strong>Record Retention:</strong> Minimum 5 years / recommended 10 years for DPMS</li>'
        +'</ul>',
      records:
