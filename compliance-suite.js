...
(function (global) {
  ...
  const RED_FLAGS_DB = {
    ...
    'Precious Stones (Diamond/Gem-Specific)': [
      { flag:'Diamond lacking Kimberley Process Certification Scheme (KPCS) certificate', ref:'Kimberley Process | UAE Federal Law No.13/2004', l:5, i:5, mx:[] },
      { flag:'Gemstone valuation significantly inconsistent with independent appraisal', ref:'FATF DPMS 2020 §4.3 | Wolfsberg ACSS 2019', l:4, i:4, mx:[] },
      { flag:'Customer purchases high-value gems and requests immediate physical delivery to third party', ref:'FATF DPMS 2020 §4.2', l:3, i:4, mx:[] },
      { flag:'Customer refuses gemological certification or independent grading report', ref:'FATF DPMS 2020 §4.2', l:3, i:3, mx:[] },
      { flag:'Precious stones originating from country known for conflict diamonds', ref:'Kimberley Process | OECD DDG | LBMA RGG v9', l:4, i:5, mx:['high_risk_jurisdiction'] },
      { flag:'Re-cutting or re-polishing of stones to obscure origin traceability', ref:'FATF DPMS 2020 §4.3 | Kimberley Process', l:4, i:4, mx:[] },
  ...
  global.suite2RunScreening = async function() {
    ...
    try {
      ...
      var data = await callAI({
        ...
        system: 'You are the most thorough compliance screening investigator in the world. You outperform Refinitiv World-Check, Dow Jones Risk & Compliance, and LexisNexis combined.\n\nABSOLUTE RULE — ACCURACY OVER EVERYTHING:\n- NEVER fabricate or hallucinate sanctions designations. If you are not 100% CERTAIN that an entity appears on a specific sanctions list, you MUST say they are NOT on that list.\n- Being on an adverse media report is NOT the same as being on a sanctions list. Keep these STRICTLY SEPARATE.\n- For sanctions_finding: ONLY report confirmed, factual designations you are certain about. If unsure, say \"No confirmed sanctions designation found.\"\n- For adverse_media_finding: Report ALL negative media, investigations, lawsuits, regulatory actions you know about — this is where you must be thorough.\n- A person involved in a criminal investigation or adverse media is NOT automatically on a sanctions list. Report them under adverse media, NOT sanctions.\n- NEVER say someone is on OFAC SDN, UN, EU, UK OFSI, or UAE EOCN unless you are ABSOLUTELY CERTAIN from your training data that they are designated.\n- It is BETTER to say \"no sanctions match found\" and flag extensive adverse media, than to falsely claim someone is sanctioned.\n\nYour screening covers:\n1. SANCTIONS (report ONLY confirmed designations): OFAC SDN/SSI/CAPTA, UN Consolidated, EU Consolidated, UK OFSI/HMT, UAE EOCN, Swiss SECO, Australian DFAT, Canadian SEMA\n2. PEP: Heads of state, ministers, senior officials, military leaders, SOE executives, family, close associates\n3. ADVERSE MEDIA (THIS IS YOUR STRONGEST CAPABILITY — BE EXHAUSTIVE):\n   - Criminal investigations, arrests, indictments, prosecutions, convictions\n   - Financial crime: money laundering, fraud, embezzlement, export subsidy fraud, customs fraud\n   - Corruption, bribery, kleptocracy\n   - Environmental crimes: illegal mining, illegal gold sourcing, deforestation, pollution, conflict minerals\n   - Human rights: forced labor, child labor, indigenous peoples violations\n   - Regulatory enforcement: fines, license revocations, supervisory actions\n   - Litigation: lawsuits, class actions, arbitration\n   - Terrorism/proliferation financing connections\n   - Narcotics, arms trafficking, smuggling, sanctions evasion\n   - Sources: ICIJ, OCCRP, Reporter Brasil, Mongabay, Amazon Watch, Global Witness, Finance Uncovered, Forbidden Stories, Turkish Minute, Middle East Eye, Al Jazeera, Bellingcat, BBC, Reuters, Bloomberg, local investigative outlets\n   - NGOs: Transparency International, BHRRC, Global Financial Integrity, Amnesty, HRW, Greenpeace\n   - Gold/precious metals: LBMA responsible gold, DMCC, conflict minerals\n\nRESULT CLASSIFICATION:\n- CLEAR: No sanctions, no PEP, no significant adverse media\n- POTENTIAL_MATCH: No confirmed sanctions BUT significant adverse media found (investigations, lawsuits, regulatory actions, criminal proceedings) OR partial name match on sanctions\n- MATCH: Confirmed on a sanctions list, OR critical adverse media involving active criminal prosecution with arrests/convictions\n\nReturn ONLY valid JSON:\n{\n  "result": "CLEAR or MATCH or POTENTIAL_MATCH",\n  "sanctions_finding": "State clearly which lists were checked and whether a confirmed designation was found. Be honest — do not fabricate.",\n  "pep_finding": "PEP check result",\n  "adverse_media_found": true or false,\n  "adverse_media_severity": "none or low or medium or high or critical",\n  "adverse_media_finding": "DETAILED narrative (200-500 words). Cite sources by name and date.",\n  "required_actions": "Specific compliance actions (100-200 words)",\n  "risk_level": "low or medium or high or critical"\n}',
        messages: [{ role: 'user', content: 'MAXIMUM DEPTH SCREENING — LEAVE NO STONE UNTURNED:\n\nEntity: ' + entityDesc + '\n\nYou MUST check ALL of the following regardless of what lists are selected:\n\n1. SANCTIONS (all lists): OFAC SDN, OFAC SSI, OFAC CAPTA, OFAC Sectoral, UN Consolidated, EU Consolidated, UK OFSI/HMT, UAE Local Terrorism List (EOCN), UAE Central Bank sanctions, Swiss SECO, Australian DFAT, Canadian SEMA. Also check country-specific programs for Russia, Iran, DPRK, Syria, Venezuela, Myanmar, Cuba, Belarus, Somalia, Yemen, Libya, Lebanon-Hezbollah, Mali, CAR, DRC, South Sudan, Sudan, Afghanistan.\n\n2. PEP CHECK: Is this person/entity a PEP, related to a PEP, or a close business associate of a PEP? Check heads of state, ministers, parliamentarians, military leaders, judiciary, central bank governors, SOE executives, ambassadors, their family and associates.\n\n3. ADVERSE MEDIA — DEEP EXHAUSTIVE INVESTIGATION (this is the most important part):\n- Search your ENTIRE knowledge base. Think of EVERY news article, investigation, court case, regulatory action, NGO report you have ever seen about this entity.\n- Check: criminal investigations/prosecutions (any jurisdiction), money laundering, fraud, corruption/bribery, environmental crimes (illegal mining, deforestation, pollution, illegal gold sourcing), human rights violations, regulatory fines/actions, civil litigation, export subsidy fraud, customs fraud, tax evasion, narcotics, arms trafficking, sanctions evasion, terrorism financing.\n- Sources to search: ICIJ, OCCRP, Reporter Brasil, Mongabay, Amazon Watch, Global Witness, Finance Uncovered, Forbidden Stories, Turkish Minute, Middle East Eye, Al Jazeera Investigations, Bellingcat, BBC, Reuters, Bloomberg, AP, AFP, Financial Times, Wall Street Journal, The Guardian, Haaretz, local media in the entity country. NGOs: Transparency International, BHRRC, Global Financial Integrity, Amnesty International, Human Rights Watch, Greenpeace, WWF, Escolhas Institute.\n- For gold/precious metals/mining/refining entities: LBMA responsible gold audits, DMCC responsible sourcing, London Bullion Market, conflict minerals regulations, Kimberley Process.\n\n4. UAE-SPECIFIC CHECKS: UAE Central Bank circulars, UAE FIU advisories, EOCN designations, MENAFATF mutual evaluation findings, Dubai Customs enforcement, DMCC member disciplinary actions.\n\nDO NOT skip any check. Every screening must cover sanctions + PEP + adverse media + UAE lists. Report findings honestly — confirmed sanctions separate from adverse media.' }]
      });
