...
(function(global) {
  ...
  global.suite2RunScreening = async function() {
    ...
    try {
      ...
      // Step 2: AI screening with live search results included
      var data = await callAI({
        model: 'claude-sonnet-4-5', max_tokens: 16000, temperature: 0,
        system: 'You are a Tier-1 compliance screening engine operating at the standard of Refinitiv World-Check, Dow Jones Risk & Compliance, and LexisNexis Bridger. Your screening output must be as comprehensive, structured, and actionable as those commercial platforms.\n\nCORE PRINCIPLES:\n1. NEVER fabricate sanctions designations. Only report CONFIRMED designations you are certain about.\n2. Adverse media is SEPARATE from sanctions. Being investigated or prosecuted does NOT equal being sanctioned.\n3. NEVER say someone is on OFAC SDN, UN, EU, UK OFSI, or UAE EOCN unless you are certain.\n4. When adverse media IS found, report it ASSERTIVELY with full detail — do NOT hedge or dilute findings with excessive caveats. State the facts clearly.\n5. ALWAYS investigate the entity\'s CORPORATE NETWORK: family members, business partners, directorships, beneficial ownership, parent/subsidiary companies, and associates. If any connected entity has adverse media or sanctions exposure, report it.\n\nADVERSE MEDIA METHODOLOGY (Refinitiv/Dow Jones Standard):\n- You must categorize adverse media into specific risk categories exactly as commercial screening platforms do:\n  * Financial Crime (money laundering, fraud, embezzlement, tax evasion)\n  * Corruption & Bribery\n  * Terrorism & Terrorism Financing\n  * Organized Crime\n  * Narcotics\n  * Sanctions Evasion\n  * Environmental Crime (illegal mining, pollution, deforestation)\n  * Human Rights Violations\n  * Regulatory Enforcement Actions\n  * Litigation & Civil Proceedings\n  * Adverse Regulatory Findings\n  * Corporate Governance Failures\n  * Arms Trafficking & Proliferation\n- For EACH adverse media finding, provide: (a) specific allegation, (b) source publication, (c) date or date range, (d) jurisdiction, (e) current status (ongoing/resolved/convicted/acquitted), (f) severity rating\n- Search COMPREHENSIVELY: ICIJ, OCCRP, Reporter Brasil, Mongabay, Amazon Watch, Global Witness, Finance Uncovered, Forbidden Stories, Turkish Minute, Ahval News, Middle East Eye, Al Jazeera, Bellingcat, BBC, Reuters, Bloomberg, AP, AFP, Financial Times, Wall Street Journal, The Guardian, Haaretz, Cumhuriyet, local/regional media. NGOs: Transparency International, BHRRC, Global Financial Integrity, Amnesty International, Human Rights Watch.\n- For gold/precious metals: LBMA RGG audits, DMCC responsible sourcing, OECD DDG, EU Conflict Minerals Regulation.\n\nCORPORATE NETWORK SCREENING (CRITICAL):\n- Identify ALL known corporate affiliations: directorships, shareholdings, beneficial ownership, family business connections\n- Screen EACH connected entity for adverse media and sanctions\n- Report corporate connections even if the individual themselves has no direct adverse media — the connection itself is a risk factor\n- For family members of business owners/directors: identify the businesses they are connected to and screen those businesses\n\nPEP SCREENING:\n- Check: heads of state, ministers, parliamentarians, military leaders, judiciary, central bank governors, SOE executives, ambassadors, and their family members and close associates\n- Include former PEPs (typically remain PEP-classified for 12-18 months after leaving office, but risk persists)\n\nSANCTIONS SCOPE:\nOFAC SDN/SSI/CAPTA/Sectoral, UN Consolidated, EU Consolidated, UK OFSI/HMT, UAE EOCN, UAE Central Bank, Swiss SECO, Australian DFAT, Canadian SEMA, plus country-specific programs\n\nLIVE WEB SEARCH RESULTS:\n- If the user message includes LIVE WEB SEARCH RESULTS, these are real-time search results from today\'s web. PRIORITIZE these over your training data — they contain the most current information.\n- Cross-reference live results with your training data for maximum accuracy.\n- If live results confirm adverse media that your training data also knows about, report with HIGH confidence.\n- If live results reveal NEW information not in your training data, report it clearly as "Live source" findings.\n\nRESULT CLASSIFICATION:\n- CLEAR: No sanctions, no PEP, no adverse media, no high-risk corporate connections\n- POTENTIAL_MATCH: adverse media found OR PEP identified OR connected to flagged entities OR high-risk sector exposure\n- MATCH: Confirmed on a sanctions list\n\nOUTPUT FORMAT — Return ONLY valid JSON:\n{"result":"CLEAR|MATCH|POTENTIAL_MATCH","sanctions_finding":"Detailed sanctions check results across all lists","pep_finding":"PEP check results including family/associate connections","adverse_media_found":true/false,"adverse_media_severity":"none|low|medium|high|critical","adverse_media_categories":["list of applicable risk categories from the methodology above"],"adverse_media_finding":"COMPREHENSIVE narrative (500-2000 words). For EACH finding include: specific allegation, source, date, jurisdiction, status. Also cover corporate network findings. Be thorough and factual — this must match the depth of Refinitiv World-Check output.","corporate_connections":"Known corporate affiliations, directorships, beneficial ownership, family business connections and their risk profiles","required_actions":"Specific, numbered action items for the compliance team","risk_level":"low|medium|high|critical","regulatory_basis":"Applicable regulations and guidance"}',
        messages: [{ role: 'user', content: 'TIER-1 COMPLIANCE SCREENING — REFINITIV/DOW JONES STANDARD:\n\nEntity: ' + entityDesc + '\n\nPERFORM ALL CHECKS REGARDLESS OF SELECTED LISTS:\n\n1. SANCTIONS (all lists): OFAC SDN, OFAC SSI, OFAC CAPTA, OFAC Sectoral, UN Consolidated, EU Consolidated, UK OFSI/HMT, UAE Local Terrorism List (EOCN), UAE Central Bank sanctions, Swiss SECO, Australian DFAT, Canadian SEMA. Also check country-specific programs for Russia, Iran, DPRK, Syria, Venezuela, Myanmar, Cuba, Belarus, Somalia, Yemen, Libya, Lebanon-Hezbollah, Mali, CAR, DRC, South Sudan, Sudan, Afghanistan.\n\n2. PEP CHECK: Is this person/entity a PEP, related to a PEP, or a close business associate of a PEP? Check heads of state, ministers, parliamentarians, military leaders, judiciary, central bank governors, SOE executives, ambassadors, their family and associates.\n\n3. CORPORATE NETWORK ANALYSIS (CRITICAL — DO NOT SKIP):\n- Identify ALL known corporate affiliations: companies where this person is a director, shareholder, beneficial owner, or connected through family\n- For each connected company: check for adverse media, regulatory actions, investigations, sanctions exposure\n- Map family connections to business entities\n- This is what separates Tier-1 screening from basic name matching\n\n4. ADVERSE MEDIA — EXHAUSTIVE DEEP INVESTIGATION:\n- Search your ENTIRE knowledge base thoroughly. Recall EVERY news article, investigation, court case, regulatory action, NGO report about this entity AND their corporate network.\n- Categories to check: financial crime (money laundering, fraud, embezzlement), corruption/bribery, terrorism/financing, organized crime, narcotics, sanctions evasion, environmental crimes (illegal mining, deforestation, pollution), human rights violations, regulatory fines/enforcement, civil litigation, tax evasion, arms trafficking, corporate governance failures.\n- Sources: ICIJ, OCCRP, Reporter Brasil, Mongabay, Amazon Watch, Global Witness, Finance Uncovered, Forbidden Stories, Turkish Minute, Ahval News, Cumhuriyet, Middle East Eye, Al Jazeera Investigations, Bellingcat, BBC, Reuters, Bloomberg, AP, AFP, Financial Times, Wall Street Journal, The Guardian, Haaretz, local media in the entity\'s country. NGOs: Transparency International, BHRRC, Global Financial Integrity, Amnesty International, Human Rights Watch, Greenpeace.\n- For gold/precious metals/mining: LBMA RGG v9, DMCC responsible sourcing, Dubai Good Delivery (DGD), OECD DDG, EU Conflict Minerals Regulation, RMI.\n- IMPORTANT: If you find adverse media, report it CLEARLY and FACTUALLY. Do not hedge or add unnecessary caveats that dilute the findings. State what was found, where, when, and current status.\n\n5. UAE-SPECIFIC CHECKS: UAE Central Bank circulars, UAE FIU advisories, EOCN designations, MENAFATF mutual evaluation findings, Dubai Customs enforcement, DMCC member disciplinary actions.\n\nDO NOT skip any check. Report findings honestly — confirmed sanctions separate from adverse media. For adverse media: be COMPREHENSIVE and SPECIFIC, matching the depth expected from Refinitiv World-Check or Dow Jones Risk & Compliance.' + liveSearchResults }]
      });
