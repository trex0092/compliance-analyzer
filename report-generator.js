...
.watermark{float:right;color:#bbb;font-size:9px;letter-spacing:2px}
    ...
    html += `<div class="header">
      ...
      <div class="meta"><strong>Company:</strong> ${data.company || 'N/A'} &nbsp;|&nbsp; <strong>Date:</strong> ${new Date().toLocaleDateString('en-GB')} &nbsp;|&nbsp; <strong>Generated by:</strong> Hawkeye Sterling V2 v2.5</div>
    </div>
    <div class="content">`;
