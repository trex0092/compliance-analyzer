...
<div class="card">
  ...
  function renderCircularsList() {
    ...
    return list.map(c => {
      ...
      return `<div class="asana-item"><div><div class="asana-name">${c.ref} — ${c.subject}${attachHtml}</div><div class="asana-meta">${c.month||'—'} | ${c.date||'—'}</div></div><div style="display:flex;gap:4px"><button class="btn btn-sm" class="btn-gold" style="padding:2px 8px;font-size:10px" onclick="ReportGenerator.editCircular(${c.id})">Edit</button><button class="btn btn-sm btn-red" style="padding:2px 8px;font-size:10px" onclick="ReportGenerator.deleteCircular(${c.id})">Delete</button></div></div>`;
    }).join('');
  }
  ...
  function renderMeetingsList() {
    ...
    return list.map(m => {
      ...
      return `<div class="asana-item"><div><div class="asana-name">${m.ref}${attachHtml}</div><div class="asana-meta">${m.month||'—'} | ${m.date||'—'}</div></div><div style="display:flex;gap:4px"><button class="btn btn-sm" class="btn-gold" style="padding:2px 8px;font-size:10px" onclick="ReportGenerator.editMeeting(${m.id})">Edit</button><button class="btn btn-sm btn-red" style="padding:2px 8px;font-size:10px" onclick="ReportGenerator.deleteMeeting(${m.id})">Delete</button></div></div>`;
    }).join('');
  }
