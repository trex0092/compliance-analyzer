...
export class ComplianceKnowledgeGraph {
  ...
  addRegulation(reg: Regulation): void {
    this.regulations.set(reg.id, reg);
  }
  addRequirement(req: Requirement): void {
    this.requirements.set(req.id, req);
  }
  addImplementation(impl: CodeImplementation): void {
    this.implementations.set(impl.id, impl);
  }
  addTest(test: TestCoverage): void {
    this.tests.set(test.id, test);
  }
  addEvidence(ev: EvidenceLink): void {
  ...
  getTraceability(regulationId: string): TraceabilityNode | null {
    ...
    const requirements = Array.from(this.requirements.values()).filter(
      (r) => r.regulationId === regulationId
    );
    const reqIds = new Set(requirements.map((r) => r.id));

    const implementations = Array.from(this.implementations.values()).filter((i) =>
      reqIds.has(i.requirementId)
    );
    ...
    const implemented =
      implementations.length > 0 && implementations.some((i) => i.implementationType === 'full');
  ...
  runGapAnalysis(): GapAnalysis {
    ...
    for (const [regId, reg] of this.regulations) {
      ...
      if (trace.implementations.length === 0) {
        ...
        trace.implementations.some(
          (i) => i.implementationType === 'partial' || i.implementationType === 'stub'
        )
      ) {
        gaps.push({
          regulationId: regId,
    ...
    const overallScore =
      total > 0
        ? Math.round(
            ((fullyImplemented * 40 + partiallyImplemented * 20) / (total * 40)) * 40 +
  ...
  seedUAERegulations(): void {
    const regs: Regulation[] = [
      {
        ...
        article: 'Art.12-14',
        description: 'CDD requirements for all customers',
      ...
      },
      {
        ...
        source: 'FDL No.10/2025',
        article: 'Art.15-16',
        description: 'DPMS cash threshold AED 55,000',
        effectiveDate: '2025-01-01',
        category: 'reporting',
      },
      {
        ...
        source: 'FDL No.10/2025',
        article: 'Art.22',
        description: 'Screen against all applicable sanctions lists',
        effectiveDate: '2025-01-01',
        category: 'sanctions',
      },
      {
      ...
      },
      {
        ...
        source: 'FDL No.10/2025',
        article: 'Art.26-27',
        description: 'File STR without delay',
        effectiveDate: '2025-01-01',
        category: 'reporting',
      },
      {
        ...
        source: 'FDL No.10/2025',
        article: 'Art.29',
        description: 'Never disclose STR to subject',
        effectiveDate: '2025-01-01',
        category: 'reporting',
      },
      {
        id: 'FDL-ART35',
        name: 'TFS Implementation',
        source: 'FDL No.10/2025',
        article: 'Art.35',
        description: 'Targeted Financial Sanctions compliance',
        effectiveDate: '2025-01-01',
        category: 'tfs',
      },
      {
        id: 'CAB134-ART5',
        name: 'Risk Appetite',
        source: 'Cabinet Res 134/2025',
        article: 'Art.5',
        description: 'Define and document risk appetite',
        effectiveDate: '2025-01-01',
        category: 'governance',
      },
      {
        ...
        source: 'Cabinet Res 134/2025',
        article: 'Art.7-10',
        description: 'SDD/CDD/EDD tiering based on risk',
        effectiveDate: '2025-01-01',
        category: 'cdd',
      },
      {
        ...
        source: 'Cabinet Res 134/2025',
        article: 'Art.14',
        description: 'PEP identification and EDD',
        effectiveDate: '2025-01-01',
        category: 'cdd',
      },
      {
        id: 'CAB74-ART4',
        name: 'Asset Freeze',
        source: 'Cabinet Res 74/2020',
        article: 'Art.4-7',
        description: 'Freeze within 24h, CNMR in 5 days',
      ...
      },
      {
        id: 'CAB109-UBO',
        name: 'UBO Register',
        source: 'Cabinet Decision 109/2023',
        article: 'Full',
        description: 'Beneficial ownership >25%, re-verify in 15 days',
      ...
      },
      {
        id: 'CAB156-PF',
        name: 'PF Controls',
        source: 'Cabinet Res 156/2025',
        article: 'Full',
        description: 'PF risk assessment, strategic goods screening',
        effectiveDate: '2025-01-01',
        category: 'pf',
      },
    ];
    ...
    const requirements: Requirement[] = [
      {
        id: 'REQ-CDD-01',
        regulationId: 'FDL-ART12',
        description: 'Verify customer identity before establishing business relationship',
        mandatory: true,
      },
      {
        id: 'REQ-CDD-02',
        regulationId: 'CAB134-ART7',
        description: 'Apply SDD for score < 6, CDD for 6-15, EDD for >= 16',
        mandatory: true,
      },
      {
        id: 'REQ-SCREEN-01',
        regulationId: 'FDL-ART22',
        description: 'Screen against UN, OFAC, EU, UK, UAE/EOCN lists',
        mandatory: true,
      },
      {
        id: 'REQ-SCREEN-02',
        regulationId: 'FDL-ART35',
        description: 'Implement TFS within 24 hours of designation',
        mandatory: true,
      },
      {
        id: 'REQ-REPORT-01',
        regulationId: 'FDL-ART26',
        description: 'File STR without delay when suspicion formed',
        mandatory: true,
      },
      {
        id: 'REQ-REPORT-02',
      ...
      {
        id: 'REQ-NOTRIP-01',
        regulationId: 'FDL-ART29',
        description: 'Do not disclose STR/SAR to subject',
        mandatory: true,
      },
      {
        id: 'REQ-FREEZE-01',
        regulationId: 'CAB74-ART4',
        description: 'Freeze assets within 24 hours',
        mandatory: true,
        deadline: '24h',
      },
      {
        id: 'REQ-FREEZE-02',
        regulationId: 'CAB74-ART4',
        description: 'File CNMR within 5 business days',
        mandatory: true,
        deadline: '5bd',
      },
      {
        id: 'REQ-UBO-01',
        regulationId: 'CAB109-UBO',
        description: 'Register UBO above 25% ownership',
        mandatory: true,
        thresholdValue: 25,
        thresholdUnit: '%',
      },
      {
        id: 'REQ-PEP-01',
        regulationId: 'CAB134-ART14',
        description: 'Apply EDD for PEPs with Senior Management approval',
        mandatory: true,
      },
      {
        id: 'REQ-PF-01',
        regulationId: 'CAB156-PF',
        description: 'Screen for PF indicators and dual-use goods',
        mandatory: true,
      },
      {
        id: 'REQ-RECORD-01',
        regulationId: 'FDL-ART24',
        description: 'Retain all compliance records for minimum 5 years',
        mandatory: true,
      },
    ];
    ...
    const implementations: CodeImplementation[] = [
      {
        id: 'IMPL-CDD-01',
        requirementId: 'REQ-CDD-01',
        filePath: 'src/domain/customers.ts',
        functionName: 'CustomerProfile',
        lineRange: { start: 1, end: 151 },
        implementationType: 'full',
        lastUpdated: '2026-04-08',
      },
      {
        id: 'IMPL-CDD-02',
        requirementId: 'REQ-CDD-02',
        filePath: 'src/services/cddRenewalEngine.ts',
        functionName: 'scanForRenewals',
        lineRange: { start: 1, end: 150 },
        implementationType: 'full',
        lastUpdated: '2026-04-08',
      },
      {
        id: 'IMPL-SCREEN-01',
        requirementId: 'REQ-SCREEN-01',
        filePath: 'src/services/sanctionsApi.ts',
        functionName: 'screenEntityComprehensive',
        lineRange: { start: 1, end: 420 },
        implementationType: 'full',
        lastUpdated: '2026-04-08',
      },
      {
        id: 'IMPL-SCREEN-02',
        requirementId: 'REQ-SCREEN-02',
        filePath: 'src/agents/definitions/incident-agent.ts',
        functionName: 'handleSanctionsMatch',
      ...
      {
        id: 'IMPL-REPORT-01',
        requirementId: 'REQ-REPORT-01',
        filePath: 'src/services/goamlBuilder.ts',
        functionName: 'buildGoAMLXml',
        lineRange: { start: 1, end: 276 },
        implementationType: 'full',
        lastUpdated: '2026-04-08',
      },
      {
        id: 'IMPL-REPORT-02',
        requirementId: 'REQ-REPORT-02',
        filePath: 'src/risk/transactionMonitoring.ts',
        functionName: 'runTransactionMonitoring',
        lineRange: { start: 1, end: 254 },
        implementationType: 'full',
        lastUpdated: '2026-04-08',
      },
      {
        id: 'IMPL-SCORING',
        requirementId: 'REQ-CDD-02',
        filePath: 'src/risk/scoring.ts',
        functionName: 'calcFlagScore',
        lineRange: { start: 1, end: 32 },
        implementationType: 'full',
        lastUpdated: '2026-04-08',
      },
      {
        id: 'IMPL-DECISION',
        requirementId: 'REQ-CDD-02',
        filePath: 'src/risk/decisions.ts',
        functionName: 'decideCase',
      ...
      {
        id: 'IMPL-UBO',
        requirementId: 'REQ-UBO-01',
        filePath: 'src/services/crossEntityScreening.ts',
        functionName: 'detectSharedUBOs',
        lineRange: { start: 1, end: 158 },
        implementationType: 'full',
        lastUpdated: '2026-04-08',
      },
      {
        id: 'IMPL-PF',
        requirementId: 'REQ-PF-01',
        filePath: 'src/risk/pfMonitoring.ts',
        functionName: 'runPFScreening',
        lineRange: { start: 1, end: 262 },
        implementationType: 'full',
        lastUpdated: '2026-04-08',
      },
      {
        id: 'IMPL-AUDIT',
        requirementId: 'REQ-RECORD-01',
        filePath: 'src/utils/auditChain.ts',
        functionName: 'createChainedEvent',
        lineRange: { start: 1, end: 94 },
        implementationType: 'full',
        lastUpdated: '2026-04-08',
      },
      {
        id: 'IMPL-NOTRIP',
        requirementId: 'REQ-NOTRIP-01',
        filePath: 'src/agents/definitions/incident-agent.ts',
        functionName: 'runIncidentAgent',
    ...
    const tests: TestCoverage[] = [
      {
        id: 'TEST-SCORING',
        implementationId: 'IMPL-SCORING',
        testFilePath: 'tests/scoring.test.ts',
        testName: 'scoring suite',
        passing: true,
        lastRun: '2026-04-09',
      },
      {
        id: 'TEST-DECISIONS',
        implementationId: 'IMPL-DECISION',
        testFilePath: 'tests/decisions.test.ts',
        testName: 'decisions suite',
        passing: true,
        lastRun: '2026-04-09',
      },
      {
        id: 'TEST-AUDIT',
        implementationId: 'IMPL-AUDIT',
        testFilePath: 'tests/auditChain.test.ts',
        testName: 'audit chain suite',
        passing: true,
        lastRun: '2026-04-09',
      },
      {
        id: 'TEST-GOAML',
        implementationId: 'IMPL-REPORT-01',
        testFilePath: 'tests/goamlValidator.test.ts',
        testName: 'goAML validator suite',
        passing: true,
        lastRun: '2026-04-09',
      },
      {
        id: 'TEST-TM',
        implementationId: 'IMPL-REPORT-02',
        testFilePath: 'tests/transactionMonitoringEngine.test.ts',
        testName: 'TM engine suite',
        passing: true,
        lastRun: '2026-04-09',
      },
      {
        id: 'TEST-KPI',
        implementationId: 'IMPL-CDD-02',
        testFilePath: 'tests/kpiFramework.test.ts',
        testName: 'KPI framework suite',
        passing: true,
        lastRun: '2026-04-09',
      },
      {
        id: 'TEST-CROSS',
        implementationId: 'IMPL-UBO',
        testFilePath: 'tests/crossEntity.test.ts',
        testName: 'cross-entity suite',
        passing: true,
        lastRun: '2026-04-09',
      },
      {
        id: 'TEST-QUANT',
        implementationId: 'IMPL-REPORT-02',
        testFilePath: 'tests/quantAnalytics.test.ts',
        testName: 'quant analytics suite',
        passing: true,
        lastRun: '2026-04-09',
      },
    ];
...
export const KNOWLEDGE_GRAPH_TOOL_SCHEMAS = [
  {
    ...
    inputSchema: {
      ...
      properties: {
        regulationId: {
          type: 'string',
          description: 'Regulation ID (e.g. FDL-ART12, CAB134-ART7)',
        },
      },
