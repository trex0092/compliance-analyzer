...
export const DPMS_KPI_DEFINITIONS: KPIDefinition[] = [
  ...
  },
  {
    ...
    category: 'screening-tfs',
    description: `Time to execute asset freeze after confirmed match (target: <${EOCN_FREEZE_DEADLINE_HOURS}h)`,
    regulatoryBasis: 'Cabinet Res 74/2020 Art.4, FDL Art.22-23',
    reportingBody: 'EOCN',
    frequency: 'quarterly',
    targetValue: EOCN_FREEZE_DEADLINE_HOURS,
    targetUnit: 'hours',
    ragThresholds: { green: 12, amber: 20 },
    inverse: true,
  },
  {
    id: 'KPI-TFS-004',
