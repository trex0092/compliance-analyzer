...
const PERMISSION_MATRIX: Record<Role, Action[]> = {
  ...
  "compliance-officer": [
    ...
    "approve-edd", "approve-ctr",
    "file-ctr",
    "view-regulatory-framework", "view-kpi-dashboard",
  ],
  mlro: [
    "view-case", "create-case", "update-case", "decide-case",
    "approve-str", "approve-sar", "approve-ctr",
    "file-report", "file-str", "file-sar", "file-ctr",
    "view-screening", "run-screening",
    "view-customer", "edit-customer",
    "view-evidence", "upload-evidence",
    "view-audit-log", "export-data",
    "approve-edd", "freeze-assets",
    "escalate-to-fiu", "escalate-to-eocn",
    "pf-escalation",
    "view-regulatory-framework", "manage-audit-checklist", "view-kpi-dashboard",
  ],
  "senior-management": [
    "view-case", "decide-case",
    "approve-str", "approve-sar", "approve-onboarding",
    "approve-edd", "freeze-assets", "unfreeze-assets",
    "approve-customer-exit",
    "view-screening",
    "view-customer",
    "view-evidence", "upload-evidence",
  ...
  admin: [
    ...
    "approve-str", "approve-sar", "approve-ctr",
    "file-report", "file-str", "file-sar", "file-ctr",
    "approve-onboarding", "approve-edd", "freeze-assets", "unfreeze-assets",
    "approve-customer-exit",
    "manage-users",
    "view-screening", "run-screening",
    "view-customer", "edit-customer",
