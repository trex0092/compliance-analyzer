...
export const REGULATORY_BODIES: RegulatoryBody[] = [
  {
    ...
    fullName: 'UAE Ministry of Economy — DPMS Supervision Division',
    jurisdiction: 'UAE',
    reportingUrl: 'https://www.moec.gov.ae',
  },
  {
    code: 'FIU',
    name: 'Financial Intelligence Unit',
    fullName: 'UAE Financial Intelligence Unit (goAML)',
    jurisdiction: 'UAE',
    reportingUrl: 'https://www.uaefiu.gov.ae',
  },
  {
    code: 'EOCN',
    name: 'EOCN',
    fullName: 'Executive Office of Control & Non-Proliferation',
    jurisdiction: 'UAE',
  },
  {
    code: 'CBUAE',
  ...
  },
  {
    ...
    fullName: 'United Nations Security Council — Sanctions Committee',
    jurisdiction: 'International',
  },
  {
    code: 'LBMA',
    name: 'LBMA',
    fullName: 'London Bullion Market Association',
    jurisdiction: 'International',
  },
  {
    code: 'OFAC',
    name: 'OFAC',
    fullName: 'Office of Foreign Assets Control (US Treasury)',
    jurisdiction: 'USA',
  },
  {
    code: 'EU',
    name: 'EU Council',
    fullName: 'Council of the European Union — Sanctions Regime',
    jurisdiction: 'EU',
  },
];
...
export const KEY_LEGISLATION: Legislation[] = [
  {
    code: 'FDL-10-2025',
    title:
      'Federal Decree-Law No. 10 of 2025 on Anti-Money Laundering and Combating the Financing of Terrorism and Financing of Illegal Organisations',
  ...
  },
  {
    code: 'CR-156-2025',
    title:
      'Cabinet Resolution No. 156 of 2025 — Proliferation Financing & Strategic Goods Controls',
  ...
  },
  {
    code: 'MOE-08-2021',
    title:
      'MoE Circular 08/AML/2021 — AML/CFT Obligations for Dealers in Precious Metals and Stones',
...
export const MOE_AUDIT_CHECKLIST: AuditChecklistItem[] = [
  ...
  {
    id: 'AC-01',
    category: 'AML/CFT Program',
    requirement: 'Documented AML/CFT compliance program approved by Senior Management',
    regulatoryRef: 'FDL No.10/2025 Art.20, MoE Guidance',
    evidenceRequired: 'Written policy document with board approval date',
    criticalForAudit: true,
  },
  {
    id: 'AC-02',
    category: 'AML/CFT Program',
    requirement: 'Designated Compliance Officer and MLRO appointed',
    regulatoryRef: 'FDL No.10/2025 Art.20, Cabinet Res 134/2025',
    evidenceRequired: 'Appointment letter, fit-and-proper checks',
    criticalForAudit: true,
  },
  {
    id: 'AC-03',
    category: 'AML/CFT Program',
    requirement: 'Enterprise-Wide Risk Assessment (EWRA) conducted and documented',
    regulatoryRef: 'FDL No.10/2025 Art.4, FATF Rec 1, MoE Guidance',
    evidenceRequired: 'EWRA report with risk matrix and methodology',
    criticalForAudit: true,
  },
  {
    id: 'AC-04',
    category: 'AML/CFT Program',
    requirement: 'Independent audit of AML/CFT program (annual or biennial)',
    regulatoryRef: 'FDL No.10/2025 Art.21, MoE Supervision',
    evidenceRequired: 'Audit report with findings and remediation plan',
    criticalForAudit: true,
  },
  ...
  // CDD/KYC
  {
    ...
    regulatoryRef: 'FDL No.10/2025 Art.12-13, Cabinet Res 134/2025 Art.4-6',
    evidenceRequired: 'Customer files with complete KYC packages',
    criticalForAudit: true,
  },
  {
    id: 'AC-06',
    category: 'CDD/KYC',
    requirement: 'Beneficial ownership identified and verified (>25% ownership threshold)',
    regulatoryRef: 'FDL No.10/2025 Art.14, Cabinet Res 134/2025 Art.7, FATF Rec 10/24',
    evidenceRequired: 'UBO register with supporting documents',
    criticalForAudit: true,
  },
  {
    id: 'AC-07',
    category: 'CDD/KYC',
    requirement: 'Risk-based CDD review frequency (high: 3mo, medium: 6mo, low: 12mo)',
    regulatoryRef: 'Cabinet Res 134/2025 Art.16, MoE Guidance',
    evidenceRequired: 'Review schedules and completed review records',
    criticalForAudit: true,
  },
  {
    id: 'AC-08',
    category: 'CDD/KYC',
    requirement: 'EDD applied to high-risk customers, PEPs, and high-risk jurisdictions',
    regulatoryRef: 'FDL No.10/2025 Art.14-15/18, FATF Rec 10/12/19',
    evidenceRequired: 'EDD files with senior management approval',
    criticalForAudit: true,
  },
  ...
  // Transaction Monitoring
  {
    ...
    requirement: 'Ongoing transaction monitoring system implemented',
    regulatoryRef: 'FDL No.10/2025 Art.15-16, FATF Rec 20/22',
    evidenceRequired: 'TM rules, alert logs, investigation records',
    criticalForAudit: true,
  },
  {
    id: 'AC-10',
    category: 'Transaction Monitoring',
    requirement: 'Cash transactions >= AED 55,000 identified and reported (CTR)',
    regulatoryRef: 'FDL No.10/2025 Art.16, MoE Circular 08/AML/2021',
    evidenceRequired: 'CTR filing records via goAML',
    criticalForAudit: true,
  },
  {
    id: 'AC-11',
    category: 'Transaction Monitoring',
    requirement: 'Structuring/smurfing detection rules in place',
    regulatoryRef: 'FDL No.10/2025 Art.16, FATF Rec 22',
    evidenceRequired: 'TM rule configuration and alert samples',
    criticalForAudit: true,
  },
  ...
  // Screening & Sanctions
  {
    id: 'AC-12',
    category: 'Screening',
    requirement: 'Sanctions screening against UN/OFAC/EU/UAE lists at onboarding and ongoing',
    regulatoryRef: 'FDL No.10/2025 Art.22-23, Cabinet Res 156/2025',
    evidenceRequired: 'Screening logs with dates, lists checked, results',
    criticalForAudit: true,
  },
  {
    id: 'AC-13',
    category: 'Screening',
    requirement: 'PEP screening at onboarding and periodically',
    regulatoryRef: 'FDL No.10/2025 Art.18, FATF Rec 12',
    evidenceRequired: 'PEP screening results per customer',
    criticalForAudit: true,
  },
  {
    id: 'AC-14',
    category: 'Screening',
    requirement: 'TFS compliance — ability to freeze assets immediately',
    regulatoryRef: 'FDL No.10/2025 Art.22-23, EOCN Protocol',
    evidenceRequired: 'TFS procedures, freeze/unfreeze logs',
    criticalForAudit: true,
  },
  ...
  // Reporting
  {
    id: 'AC-15',
    category: 'Reporting',
    requirement: 'STR/SAR filing procedures documented and followed',
    regulatoryRef: 'FDL No.10/2025 Art.26, FIU goAML Guide',
    evidenceRequired: 'STR/SAR filing log, goAML submissions',
    criticalForAudit: true,
  },
  {
    id: 'AC-16',
    category: 'Reporting',
    requirement: 'No tipping-off — procedures to prevent customer notification of STR',
    regulatoryRef: 'FDL No.10/2025 Art.27',
    evidenceRequired: 'Access controls, need-to-know policy',
    criticalForAudit: true,
  },
  {
    id: 'AC-17',
    category: 'Reporting',
    requirement: 'EOCN reporting within 24 hours for TFS/PF matches',
    regulatoryRef: 'Cabinet Res 156/2025 Art.11, EOCN Protocol',
    evidenceRequired: 'EOCN communication logs',
    criticalForAudit: true,
  },
  ...
  // Record Keeping
  {
    ...
    requirement: 'All CDD records retained for minimum 10 years after end of business relationship',
    regulatoryRef: 'FDL No.10/2025 Art.28, Cabinet Res 134/2025',
    evidenceRequired: 'Record retention policy, data storage evidence',
    criticalForAudit: true,
  },
  {
    id: 'AC-19',
    category: 'Record Keeping',
    requirement: 'Transaction records retained for minimum 10 years',
    regulatoryRef: 'FDL No.10/2025 Art.28',
    evidenceRequired: 'Transaction archives, audit trail',
    criticalForAudit: true,
  },
  ...
  // Training
  {
    id: 'AC-20',
    category: 'Training',
    requirement: 'AML/CFT training for all relevant staff — annual minimum',
    regulatoryRef: 'FDL No.10/2025 Art.20, MoE Guidance',
    evidenceRequired: 'Training records, attendance logs, certificates',
    criticalForAudit: true,
  },
  {
    id: 'AC-21',
    category: 'Training',
    requirement: 'Role-specific training for MLRO and Compliance team',
    regulatoryRef: 'MoE DPMS Supervisory Expectations',
    evidenceRequired: 'Specialized training certificates',
    criticalForAudit: true,
  },
  ...
  // PF/TFS
  {
    id: 'AC-22',
    category: 'PF/TFS',
    requirement: 'Proliferation financing risk assessment conducted',
    regulatoryRef: 'Cabinet Res 156/2025, FATF Rec 1/7',
    evidenceRequired: 'PF risk assessment document',
    criticalForAudit: true,
  },
  {
    id: 'AC-23',
    category: 'PF/TFS',
    requirement: 'Strategic goods and dual-use screening implemented',
    regulatoryRef: 'Cabinet Res 156/2025 Art.3-5',
    evidenceRequired: 'Screening system logs, rule configuration',
    criticalForAudit: true,
  },
  ...
  // Supply Chain (DPMS-specific)
  {
    ...
    requirement: 'Know Your Supplier (KYS) due diligence for precious metals sourcing',
    regulatoryRef: 'LBMA RGG v9, MoE DPMS Guidance, OECD DDG',
    evidenceRequired: 'Supplier DD files, origin certificates, chain-of-custody',
    criticalForAudit: true,
  },
  {
    id: 'AC-25',
    category: 'Supply Chain',
    requirement: 'CAHRA (Conflict-Affected High-Risk Area) assessment for gold sourcing',
    regulatoryRef: 'LBMA RGG v9, OECD DDG Annex II',
    evidenceRequired: 'CAHRA risk assessments per supplier',
    criticalForAudit: false,
  },
];
 ...
 */
export function assessAuditReadiness(completedItems: string[]): {
  totalItems: number;
