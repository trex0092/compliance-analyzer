...
export function hasPermission(
  ...
  const PERMISSION_MAP: Record<string, PermissionAction[]> = {
    analyst: [
      "view-cases", "edit-cases", "view-screening", "view-alerts",
      "view-evidence", "view-audit-log", "view-kpi-dashboard",
      "view-regulatory-framework",
    ],
    "compliance-officer": [
      "view-cases", "edit-cases", "create-cases", "view-screening",
      "run-screening", "view-alerts", "dismiss-alerts", "view-evidence",
      "upload-evidence", "view-reports", "create-reports", "approve-str",
      "view-audit-log", "export-data", "view-kpi-dashboard",
      "view-regulatory-framework",
    ],
    mlro: [
      "view-cases", "edit-cases", "create-cases", "close-cases",
      "view-screening", "run-screening", "view-alerts", "dismiss-alerts",
      "view-evidence", "upload-evidence", "view-reports", "create-reports",
      "approve-str", "approve-sar", "approve-freeze", "view-audit-log",
      "export-data", "manage-audit-checklist", "view-kpi-dashboard",
      "view-regulatory-framework",
    ],
    "senior-management": [
      "view-cases", "view-screening", "view-alerts", "view-evidence",
      "view-reports", "approve-str", "approve-sar", "approve-freeze",
      "approve-high-risk", "approve-pep", "view-audit-log", "export-data",
      "manage-audit-checklist", "view-kpi-dashboard", "view-regulatory-framework",
    ],
    admin: ["*"],
    "external-auditor": [
      "view-cases", "view-screening", "view-alerts", "view-evidence",
      "view-reports", "view-audit-log", "export-data",
      "manage-audit-checklist", "view-kpi-dashboard", "view-regulatory-framework",
    ],
...
export function getPermissions(userRole: RoleName): PermissionAction[] {
  ...
  const allActions: PermissionAction[] = [
    ...
    "view-screening", "run-screening", "view-alerts", "dismiss-alerts",
    "view-evidence", "upload-evidence", "view-reports", "create-reports",
    "approve-str", "approve-sar", "approve-freeze", "approve-high-risk",
    "approve-pep", "view-audit-log", "export-data", "manage-audit-checklist",
    "view-kpi-dashboard", "view-regulatory-framework",
  ];
