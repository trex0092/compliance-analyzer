...
function buildCaseTaskPayload(
  ...
  return {
    ...
    notes: [
      ...
      ``,
      `---`,
      `Auto-created by Compliance Analyzer`,
...
function buildAlertTaskPayload(
  ...
  return {
    ...
    notes: [
      ...
      ``,
      `---`,
      `Auto-created by Compliance Analyzer Alert Engine`,
...
function buildApprovalTaskPayload(
  ...
  return {
    ...
    notes: [
      ...
      `Recommendation: ${caseObj.recommendation}`,
      ``,
      `Regulatory Basis: Cabinet Resolution 134/2025 Art.12-14 | 4-Eyes Principle`,
      ``,
      `---`,
      `Auto-created by Compliance Analyzer Approval Workflow`,
    ].join("\n"),
    projects: [projectId],
    due_on: dueInDays(2),
  };
...
function buildReviewTaskPayload(
  ...
  return {
    ...
    notes: [
      ...
      ``,
      `---`,
      `Auto-created by Compliance Analyzer Periodic Review`,
    ].join("\n"),
    projects: [projectId],
